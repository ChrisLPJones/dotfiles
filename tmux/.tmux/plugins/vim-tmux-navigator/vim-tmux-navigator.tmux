...
move_left="$(get_tmux_option "@vim_navigator_mapping_left" 'M-Left')"
move_right="$(get_tmux_option "@vim_navigator_mapping_right" 'M-Right')"
move_up="$(get_tmux_option "@vim_navigator_mapping_up" 'M-Up')"
move_down="$(get_tmux_option "@vim_navigator_mapping_down" 'M-Down')"
